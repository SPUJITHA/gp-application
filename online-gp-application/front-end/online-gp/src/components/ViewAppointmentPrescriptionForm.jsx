...
const ViewAppointmentPrescriptionForm = () => {
...
<div className="button-container">
          ...
          <button type="button" className="cancel-prescription" onClick={navigateToAppointments}>
...
export default ViewAppointmentPrescriptionForm;